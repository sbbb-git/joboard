...
const STR: Record<Locale, SearchStrings> = {
  en: {
    ...
    noMatches: 'No matches', noMatchesBody: 'Try removing a filter or two. New jobs land every Monday at 04:00 UTC.',
  ...
  fr: {
    ...
    noMatches: 'Aucun résultat', noMatchesBody: "Essayez de retirer un filtre. De nouvelles offres arrivent chaque lundi à 04:00 UTC.",
  ...
  de: {
    ...
    noMatches: 'Keine Treffer', noMatchesBody: 'Versuchen Sie, einen Filter zu entfernen. Neue Jobs kommen jeden Montag um 04:00 UTC.',
