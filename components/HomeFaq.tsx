...
const FAQS_BY_LOCALE: Record<Locale, { heading: string; eyebrow: string; faqs: Faq[] }> = {
  en: {
    ...
    faqs: [
      ...
      { q: 'Is it free to browse?', a: 'Yes. Browsing every job, salary page and guide is free, with no signup required, and there are no paid listings.' },
      ...
      { q: 'How do I post a job?', a: 'If your job is already listed on any of the ten source boards, it lands here automatically within a week, at no cost. There is no paid option.' },
    ],
  },
  fr: {
    eyebrow: 'FAQ',
    ...
    faqs: [
      ...
      { q: 'Est-ce gratuit ?', a: "Oui. Parcourir les offres, les pages salaires et les guides est gratuit, sans inscription, et il n'y a aucune annonce payante." },
      ...
      { q: 'Comment publier une offre ?', a: "Si votre offre est déjà listée sur un des dix job boards sources, elle apparaît ici automatiquement sous une semaine, sans frais. Il n'y a pas d'option payante." },
    ],
  },
  de: {
    eyebrow: 'FAQ',
    ...
    faqs: [
      ...
      { q: 'Ist die Nutzung kostenlos?', a: 'Ja. Jeden Job, jede Gehaltsseite und jeden Guide zu durchsuchen ist kostenlos, ohne Anmeldung, und es gibt keine bezahlten Anzeigen.' },
      ...
      { q: 'Wie poste ich einen Job?', a: 'Wenn Ihr Job bereits auf einem der zehn Quellen-Boards gelistet ist, erscheint er hier automatisch innerhalb einer Woche, kostenlos. Eine bezahlte Option gibt es nicht.' },
    ],
  },
};
