...
const en: Dict = {
  ...
  'footer.worldCup': '2026 World Cup',
...
const it: Dict = {
  ...
  'footer.worldCup': 'Mondiali 2026',
  'footer.stack': 'Il nostro stack',
  'footer.glossary': 'Glossario',
  'footer.disclosure': 'Divulgazione affiliati',
  'footer.about': 'Chi siamo',
  'footer.network': 'La nostra rete',
